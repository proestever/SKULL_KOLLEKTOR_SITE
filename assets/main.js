...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image02', { style: 'focus-image', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text03', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#image01', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		...
		onvisible.add('#image04', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text02', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('#image06', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text09', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('#image03', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('#image05', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text08', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('#image07', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text07', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 1, delay: 0, replay: false });
